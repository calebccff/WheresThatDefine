...
#define BATTERY_CHARGER_STATUS_3_REG			0x1009
#define FV_POST_JEITA_MASK				GENMASK(7, 0)

#define BATTERY_CHARGER_STATUS_4_REG			0x100A
...
#define BATTERY_CHARGER_STATUS_6_REG			0x100C
...
#define BATTERY_CHARGER_STATUS_7_REG			0x100D
...
#define BATTERY_CHARGER_STATUS_8_REG			0x100E
...
#define STEP_CHG_SOC_VBATT_V_REG			0x1040
#define STEP_CHG_SOC_VBATT_V_MASK			GENMASK(7, 0)

#define STEP_CHG_SOC_VBATT_V_UPDATE_REG			0x1041
#define STEP_CHG_SOC_VBATT_V_UPDATE_BIT			BIT(0)

#define CHARGING_ENABLE_CMD_REG				0x1042
#define CHARGING_ENABLE_CMD_BIT				BIT(0)

#define ALLOW_FAST_CHARGING_CMD_REG			0x1043
#define ALLOW_FAST_CHARGING_CMD_BIT			BIT(0)

#define QNOVO_PT_ENABLE_CMD_REG				0x1044
#define QNOVO_PT_ENABLE_CMD_BIT				BIT(0)

#define CHGR_CFG1_REG					0x1050
#define INCREASE_RCHG_TIMEOUT_CFG_BIT			BIT(1)
#define LOAD_BAT_BIT					BIT(0)

#define CHGR_CFG2_REG					0x1051
...
#define FG_UPDATE_CFG_1_SEL_REG		0x107B
...
#define FG_UPDATE_CFG_2_REG		0x107C
...
#define FG_UPDATE_CFG_2_SEL_REG			0x107D
...
#define FG_CHG_INTERFACE_CFG_REG	0x107E
...
#define FG_CHG_INTERFACE_CFG_SEL_REG	0x107F
...
#define CHGR_STEP_CHG_MODE_CFG_REG		0x10B0
...
#define STEP_CHG_UPDATE_REQUEST_TIMEOUT_CFG_REG		0x10B1
...
#define STEP_CHG_UPDATE_FAIL_TIMEOUT_CFG_REG		0x10B2
...
#define STEP_CHG_SOC_OR_BATT_V_TH1_REG	0x10B3
#define STEP_CHG_SOC_OR_BATT_V_TH2_REG	0x10B4
#define STEP_CHG_SOC_OR_BATT_V_TH3_REG	0x10B5
#define STEP_CHG_SOC_OR_BATT_V_TH4_REG	0x10B6
#define STEP_CHG_CURRENT_DELTA1_REG	0x10B7
#define STEP_CHG_CURRENT_DELTA2_REG	0x10B8
#define STEP_CHG_CURRENT_DELTA3_REG	0x10B9
#define STEP_CHG_CURRENT_DELTA4_REG	0x10BA
#define STEP_CHG_CURRENT_DELTA5_REG	0x10BB

/* OTG Peripheral Registers */
#define RID_CC_CONTROL_23_16_REG	0x1106
...
#define RID_CC_CONTROL_15_8_REG		0x1107
...
#define RID_CC_CONTROL_7_0_REG		0x1108
...
#define CMD_OTG_REG			0x1140
#define OTG_EN_BIT			BIT(0)

#define BAT_UVLO_THRESHOLD_CFG_REG	0x1151
#define BAT_UVLO_THRESHOLD_MASK		GENMASK(1, 0)

#define OTG_CURRENT_LIMIT_CFG_REG	0x1152
#define OTG_CURRENT_LIMIT_MASK		GENMASK(2, 0)

#define OTG_CFG_REG			0x1153
...
#define OTG_ENG_OTG_CFG_REG		0x11C0
...
#define APSD_RESULT_STATUS_REG		0x1308
...
#define QC_CHANGE_STATUS_REG		0x1309
...
#define TYPE_C_STATUS_2_REG			0x130C
...
#define TYPE_C_STATUS_3_REG			0x130D
...
#define TYPE_C_STATUS_4_REG			0x130E
...
#define TYPE_C_STATUS_5_REG			0x130F
...
#define QC_PULSE_COUNT_STATUS_1_REG		0x1330

#define USBIN_CMD_IL_REG			0x1340
#define BAT_2_SYS_FET_DIS_BIT			BIT(1)
#define USBIN_SUSPEND_BIT			BIT(0)

#define CMD_APSD_REG				0x1341
#define ICL_OVERRIDE_BIT			BIT(1)
#define APSD_RERUN_BIT				BIT(0)

#define CMD_HVDCP_2_REG				0x1343
...
#define USB_MISC2_REG				0x1357
#define USB_MISC2_MASK				GENMASK(1, 0)

#define TYPE_C_CFG_REG				0x1358
...
#define TYPE_C_CFG_2_REG			0x1359
...
#define TYPE_C_CFG_3_REG			0x135A
...
#define HVDCP_PULSE_COUNT_MAX_REG		0x135B
...
#define USBIN_ADAPTER_ALLOW_CFG_REG		0x1360
...
#define USBIN_OPTIONS_1_CFG_REG			0x1362
...
#define USBIN_OPTIONS_2_CFG_REG			0x1363
...
#define TAPER_TIMER_SEL_CFG_REG			0x1364
...
#define TYPE_C_INTRPT_ENB_REG			0x1367
...
#define TYPE_C_INTRPT_ENB_SOFTWARE_CTRL_REG	0x1368
...
#define USBIN_SOURCE_CHANGE_INTRPT_ENB_REG	0x1369
...
#define USBIN_AICL_OPTIONS_CFG_REG		0x1380
...
#define USBIN_5V_AICL_THRESHOLD_CFG_REG		0x1381
#define USBIN_5V_AICL_THRESHOLD_CFG_MASK	GENMASK(2, 0)

#define USBIN_9V_AICL_THRESHOLD_CFG_REG		0x1382
#define USBIN_9V_AICL_THRESHOLD_CFG_MASK	GENMASK(2, 0)

#define USBIN_12V_AICL_THRESHOLD_CFG_REG	0x1383
#define USBIN_12V_AICL_THRESHOLD_CFG_MASK	GENMASK(2, 0)

#define USBIN_CONT_AICL_THRESHOLD_CFG_REG	0x1384
#define USBIN_CONT_AICL_THRESHOLD_CFG_MASK	GENMASK(5, 0)

/* DCIN Peripheral Registers */
#define DCIN_INPUT_STATUS_REG		0x1406
...
#define WIPWR_STATUS_REG		0x1407
...
#define WIPWR_RANGE_STATUS_REG		0x1408
#define WIPWR_RANGE_STATUS_MASK		GENMASK(4, 0)

/* DCIN Interrupt Bits */
#define DCIN_INT_RT_STS			0x1410
...
#define DC_SPARE_REG				0x1458
#define DC_SPARE_MASK				GENMASK(3, 0)

#define DCIN_ADAPTER_ALLOW_CFG_REG		0x1460
#define DCIN_ADAPTER_ALLOW_MASK			GENMASK(3, 0)

#define DCIN_LOAD_CFG_REG			0x1465
#define DCIN_OV_CH_LOAD_OPTION_BIT		BIT(7)

#define DCIN_CURRENT_LIMIT_CFG_REG		0x1470
...
#define ZIN_ICL_PT_HV_REG			0x1496
#define ZIN_ICL_PT_HV_MASK			GENMASK(7, 0)

#define ZIN_ICL_MID_LV_REG			0x1497
#define ZIN_ICL_MID_LV_MASK			GENMASK(7, 0)

#define ZIN_ICL_MID_HV_REG			0x1498
...
#define DC_ENG_SSUPPLY_CFG2_REG			0x14C1
#define ENG_SSUPPLY_IVREF_OTG_SS_MASK		GENMASK(2, 0)
#define OTG_SS_SLOW				0x3

#define DC_ENG_SSUPPLY_CFG3_REG			0x14C2
...
#define REVISION1_REG				0x1600
#define DIG_MINOR_MASK				GENMASK(7, 0)

#define REVISION2_REG				0x1601
#define DIG_MAJOR_MASK				GENMASK(7, 0)

#define REVISION3_REG				0x1602
#define ANA_MINOR_MASK				GENMASK(7, 0)

#define REVISION4_REG				0x1603
#define ANA_MAJOR_MASK				GENMASK(7, 0)

#define TEMP_RANGE_STATUS_REG			0x1606
...
#define ICL_STATUS_REG				0x1607
#define INPUT_CURRENT_LIMIT_MASK		GENMASK(7, 0)

#define ADAPTER_5V_ICL_STATUS_REG		0x1608
#define ADAPTER_5V_ICL_MASK			GENMASK(7, 0)

#define ADAPTER_9V_ICL_STATUS_REG		0x1609
#define ADAPTER_9V_ICL_MASK			GENMASK(7, 0)

#define AICL_STATUS_REG				0x160A
...
#define POWER_PATH_STATUS_REG			0x160B
...
#define WDOG_RST_REG				0x1640
#define WDOG_RST_BIT				BIT(0)

#define AFP_MODE_REG				0x1641
#define AFP_MODE_EN_BIT				BIT(0)

#define GSM_PA_ON_ADJ_EN_REG			0x1642
#define GSM_PA_ON_ADJ_EN_BIT			BIT(0)

#define BARK_BITE_WDOG_PET_REG			0x1643
#define BARK_BITE_WDOG_PET_BIT			BIT(0)

#define PHYON_CMD_REG				0x1644
#define PHYON_CMD_BIT				BIT(0)

#define SHDN_CMD_REG				0x1645
#define SHDN_CMD_BIT				BIT(0)

#define FINISH_COPY_COMMAND_REG			0x164F
#define START_COPY_BIT				BIT(0)

#define WD_CFG_REG				0x1651
...
#define TREG_DIE_CMP_INC_CYCLE_TIME_CFG_REG	0x1671
#define TREG_DIE_CMP_INC_CYCLE_TIME_MASK	GENMASK(1, 0)

#define TREG_DIE_CMP_DEC_CYCLE_TIME_CFG_REG	0x1672
#define TREG_DIE_CMP_DEC_CYCLE_TIME_MASK	GENMASK(1, 0)

#define TREG_DIE_ADC_INC_CYCLE_TIME_CFG_REG	0x1673
#define TREG_DIE_ADC_INC_CYCLE_TIME_MASK	GENMASK(1, 0)

#define TREG_DIE_ADC_DEC_CYCLE_TIME_CFG_REG	0x1674
#define TREG_DIE_ADC_DEC_CYCLE_TIME_MASK	GENMASK(1, 0)

#define TREG_SKIN_ADC_INC_CYCLE_TIME_CFG_REG	0x1675
#define TREG_SKIN_ADC_INC_CYCLE_TIME_MASK	GENMASK(1, 0)

#define TREG_SKIN_ADC_DEC_CYCLE_TIME_CFG_REG	0x1676
#define TREG_SKIN_ADC_DEC_CYCLE_TIME_MASK	GENMASK(1, 0)

#define BUCK_OPTIONS_CFG_REG			0x1680
...
#define ICL_SOFTSTART_RATE_CFG_REG		0x1681
#define ICL_SOFTSTART_RATE_MASK			GENMASK(1, 0)

#define ICL_SOFTSTOP_RATE_CFG_REG		0x1682
#define ICL_SOFTSTOP_RATE_MASK			GENMASK(1, 0)

#define VSYS_MIN_SEL_CFG_REG			0x1683
#define VSYS_MIN_SEL_MASK			GENMASK(1, 0)

#define TRACKING_VOLTAGE_SEL_CFG_REG		0x1684
#define TRACKING_VOLTAGE_SEL_BIT		BIT(0)

#define STAT_CFG_REG				0x1690
...
#define CFG_BUCKBOOST_FREQ_SELECT_BUCK_REG	0x16A0
#define CFG_BUCKBOOST_FREQ_SELECT_BOOST_REG	0x16A1

#define TM_IO_DTEST4_SEL			0x16E9

#define ENG_SDCDC_CFG7_REG			0x16C6
#define ENG_SDCDC_BST_SET_POINT_MASK		GENMASK(7, 6)

/* CHGR FREQ Peripheral registers */
#define FREQ_CLK_DIV_REG			0x1950
